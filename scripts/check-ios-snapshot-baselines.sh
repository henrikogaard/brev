...
required=(
  ...
  "$snapshot_root/PhoneMailboxSnapshotTests/twoAccountMailboxes-dark.dark.png"
  "$snapshot_root/PhoneMailboxSnapshotTests/twoAccountMailboxes-dark.light.png"
  "$snapshot_root/PhoneMailboxSnapshotTests/conversation-accessibility.accessibility.png"
  "$snapshot_root/PhoneMailboxSnapshotTests/conversation-accessibility.standard.png"
  "$snapshot_root/PhoneMailboxSnapshotTests/phoneCompose-accessibility.accessibility.png"
  "$snapshot_root/PhoneMailboxSnapshotTests/phoneCompose-accessibility.standard.png"
